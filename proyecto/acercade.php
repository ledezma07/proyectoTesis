...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>A CERCA DEL DESARROLLADOR</title>
...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
      ...
      <span class="fs-4">ACERCA DEL DESARROLLADOR</span>
    </a>
  </header>

  <main>
    <h1 class="text-body-emphasis">INGENIERO DE SISTEMAS</h1>
    <p class="fs-5 col-md-8">Ing. Gonzalo Richard Ledezma Quispe </br> Estudiso realziados en la facultad nacional deingenieria en la carrera de ingenieria de sistemas e informatica.
    Analista de Sistemas y Programador de Computadoras
    </p>

    <div class="mb-5">
      <a href="../examples/" class="btn btn-primary btn-lg px-4">Ver curriculum</a>
    </div>
    ...
    <div class="row g-5">
      <div class="col-md-6">
        <h2 class="text-body-emphasis">Proyectos Desarrollados</h2>
  ...
  <footer class="pt-5 my-5 text-body-secondary border-top">
    Created by the Ledezma team &middot; &copy; 2024
  </footer>
</div>
